...
<div class="right_col" role="main">
  <div class="">
    <div class="row">
      ...
      <form method="POST" action="<?php echo base_url();?>padmin/save_user_alumni" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <br><div id="gender"  class="btn-group" data-toggle="buttons">
      ...
      <div class="panel panel-primary setup-content" id="step-4">
        ...
        <div class="panel-body">
          <div class="col-md-12">
            <div class="form-group">
              <label><h5 style="font-family:Open Sans; font-weight:lighter;">Fakultas</h5></label>
              <select name="fakultas" class="form-control">
                <?php foreach($fak->result_array() as $i ): ?>
                  <option value="<?php echo $i['fakultas_id']; ?>"><?php echo $i['fakultas_nama']; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <label><h5 style="font-family:Open Sans; font-weight:lighter;">Program Studi</h5></label>
              <select name="prodi" class="form-control">
                <?php foreach($prod->result_array() as $i ): ?>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label><h5 style="font-family:Open Sans; font-weight:lighter;">Angkatan</h5></label>
              <input type="text"  class="form-control" name="angkatan">
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <label><h5 style="font-family:Open Sans; font-weight:lighter;">Wisuda</h5></label>
              <input type="text"   class="form-control" name="wisuda">
            </div>
          </div>
...
<script src="<?php echo base_url(); ?>assets/mix/formwizard/jquery.3.2.1.query.min.js"></script>
