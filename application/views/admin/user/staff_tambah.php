  ...
  <div class="">
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <form method="POST" action="<?php echo base_url();?>padmin/save_user_staff" enctype="multipart/form-data">
          <div class="panel panel-primary setup-content" id="step-1">
            ...
            <div class="panel-body">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label><h5 style="font-family:Open Sans; font-weight:lighter;">Role</h5></label>
          ...
          <div class="panel panel-primary setup-content" id="step-2">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input  class="form-control" namme="tgl_lahir" type="date">
