          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li><a href="#myModaltambah" class="btn btn-default" id="custId" data-toggle="modal" ><i class="fa fa-plus-circle"></i> Tambah Slide</a></li>
              </ul>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  foreach ($data->result_array() as $i) :
                   ...
                   ?>
                   <tr>
                    <td width="240px"><img src="<?php echo base_url().'assets/images/'.$i['slide_gambar'];?>" width="240px" class="img img-responsive"></td>
                    <td><?php echo $i['slide_judul']; ?></td>
                    <td><?php echo $i['slide_ket']; ?></td>
                    <td><?php echo date('d M Y H:i:s',strtotime($i['slide_tanggal'])); ?></td>
                    <td  class="text-center">
                     <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a data-toggle="modal" data-target="#ModalEdit<?php echo $i['slide_id'];?>">Edit</a>
                        </li>
                        <li><a data-toggle="modal" data-target="#ModalHapus<?php echo $i['slide_id'];?>">Hapus</a>
                        </li>
                      </ul>
                    </div>
                  </td>
